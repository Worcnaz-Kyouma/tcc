"""
benchmark_faster_rcnn.py
Nicolas Almeida Prado, UEPG:2026

Tips:
    python benchmark_faster_rcnn.py
    python benchmark_faster_rcnn.py --completo
"""
...
# Aquecimento da GPU antes de medir FPS
N_WARMUP = 20
...
def carregar_modelo(device: torch.device):
    print("Carregando Faster R-CNN ResNet-50+FPN V2 com pesos COCO_V1...")
...
def main():
    ...
    fps_path = OUTPUT_DIR / f"faster_rcnn_fps_{sufixo}.txt"
